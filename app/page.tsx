...
function IconQr() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true">
      <path d="M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h2v2h-2v-2Zm4 0h2v6h-6v-2h4v-4Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
    </svg>
  );
}
function IconVideo() {
...
function IconShield() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true">
      <path d="M12 3 5.5 5.5v5.8c0 4.3 2.7 8.2 6.5 9.7 3.8-1.5 6.5-5.4 6.5-9.7V5.5L12 3Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
    </svg>
  );
}
function PhoneNo() {
...
function PhoneOk() {
  return (
    <i className="ok">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#fff" aria-hidden="true">
        <path d="M6.62 10.79a15.05 15.05 0 0 0 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.21z" />
      </svg>
    </i>
  );
}
      ...
      <header className="header">
        <div className="wrap nav">
          <Link href="/" className="logo" aria-label="MobilDiafon ana sayfa">
            <img src="/icon-192.png" alt="MobilDiafon" width={38} height={38} />
            <span className="word">
              <span className="m">Mobil</span><span className="d">Diafon</span>
              <small>Dijital Diafon Platformu</small>
            </span>
          </Link>
          ...
          <nav className={`nav-links ${open ? "open" : ""}`}>
            ...
            <a href="#fiyat" onClick={close}>Fiyatlandırma</a>
            <Link href="/yonetici" className="only-mobile" onClick={close}>Yönetici Girişi</Link>
            <Link href="/guvenlik" className="only-mobile" onClick={close}>Güvenlik Girişi</Link>
          </nav>
  ...
  return (
    ...
    >
      <button className="hc-arrow hc-prev" onClick={prev} aria-label="Önceki">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="m15 6-6 6 6 6" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
      </button>
      <button className="hc-arrow hc-next" onClick={next} aria-label="Sonraki">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="m9 6 6 6-6 6" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
      </button>
          ...
          <div className={cls(0)}>
            <div className="wrap hc-grid">
              ...
              <div className="stage anim" aria-hidden="true">
                <div className="fcard f-tl">
                  <h5>Konum alanı <span className="tag">120 m</span></h5>
                  <p>Bina çevresinde liste açılır</p>
                </div>
                <div className="fcard f-br">
                  <h5>Yıldız Sitesi · A Blok</h5>
                  <p>48 daire · 92 sakin</p>
                </div>
                <div className="phone">
                  ...
                  <div className="screen">
                    ...
                    <h4>Apartman Girişi</h4>
                    <span className="meta">Daire 12 · Ziyaretçi</span>
                    <CallActions />
          ...
          <div className={cls(1)}>
            <div className="wrap hc-grid">
              <div className="hc-text">
                ...
                <div className="badges anim">
                  <span><IconQr /> Panelsiz, kablosuz</span>
                  <span><IconShield /> Uzaktan kapı açma</span>
                </div>
              </div>
              <div className="stage anim" aria-hidden="true">
                <div className="fcard f-tr">
                  <h5>Villa QR <span className="tag">✓ Doğrulandı</span></h5>
                  <div className="qrbox" />
                </div>
                <div className="phone">
                  <div className="phone-notch" />
                  <div className="screen">
                    ...
                    <h4>Bahçe Kapısı</h4>
                    <span className="meta">Ziyaretçi geldi</span>
                    <CallActions />
          ...
          <div className={cls(2)}>
            <div className="wrap hc-grid">
              <div className="hc-text">
                ...
                <div className="badges anim">
                  <span><IconQr /> Kategorili birimler</span>
                  <span><IconVideo /> Sipariş / talep notu</span>
                </div>
              </div>
              <div className="stage anim" aria-hidden="true">
                <div className="fcard f-tl">
                  <h5>Oda 312 <span className="tag">QR ✓</span></h5>
                  <p>Misafir araması</p>
                </div>
                <div className="fcard f-br" style={{ width: 215 }}>
                ...
                <div className="phone">
                  ...
                  <div className="screen">
                    ...
                    <h4>Resepsiyon</h4>
                    <span className="meta">Oda 312 arıyor</span>
                    <CallActions />
          ...
          <div className={cls(3)}>
            <div className="wrap hc-grid">
              <div className="hc-text">
                ...
                <div className="badges anim">
                  <span><IconShield /> Tuya / Zigbee</span>
                  <span><IconQr /> Kapı · bariyer · turnike</span>
                </div>
              </div>
              <div className="stage anim" aria-hidden="true">
                <div className="fcard f-tr">
                  <h5>Akıllı Cihazlar</h5>
                ...
                <div className="phone">
                  ...
                  <div className="screen">
                    ...
                    <h4>Apartman Girişi</h4>
                    <span className="meta">Görüntülü görüşme</span>
                    <span className="door door-open">🔓 Kapıyı Aç</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="hc-dots" role="tablist" aria-label="Slaytlar">
        {[0, 1, 2, 3].map((k) => (
          <button
            key={k}
            className={`hc-dot ${index === k ? "is-active" : ""}`}
            onClick={() => go(k)}
